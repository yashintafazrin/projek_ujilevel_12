<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="btn btn-sm btn-primary" style="margin-left: 195px">
                <?php
                    $grand_total = 0;
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <h3 class="text-center">Input Pemesanan Menu</h3>
                    <hr>
                    <form action="<?php echo base_url().'dashboard/proses_simpan_pesanan'?>" method="post" enctype="multipart/form-data">
